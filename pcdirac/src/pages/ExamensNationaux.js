...
const ExamensNationaux = () => {
    const [ExamensNationaux, setExamensNationaux] = useState([]); // generic name for courses/exercices
            ...
            const [loading, setLoading] = useState(true);
              ...
              // Apply user filters
              const displayedItems = ExamensNationaux.filter(item => {
                return (
                    ...
                    <>
                      ...
                      <div className="itemsGrid">
                        {displayedItems.length > 0 ? (
                          ...
                          <p className="noItemsText">Aucun Examen National trouvé pour ces filtres.</p>
                        )}
                      </div>
                    </>
                  )}
