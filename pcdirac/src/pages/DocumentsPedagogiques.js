...
const DocumentsPedagogiques = () => {
  const [DocumentsPedagogiques, setDocumentsPedagogiques] = useState([]);
  ...
  const matieresStatic = niveauFilter && documentsPedagogiquesData[niveauFilter]
    ? Object.keys(documentsPedagogiquesData[niveauFilter])
    : [];
  ...
  const unitesStatic =
    niveauFilter && matiereFilter && documentsPedagogiquesData[niveauFilter] && documentsPedagogiquesData[niveauFilter][matiereFilter]
      ? Object.keys(documentsPedagogiquesData[niveauFilter][matiereFilter])
      : [];
  ...
  const titresStatic =
    ...
    documentsPedagogiquesData[niveauFilter] &&
    documentsPedagogiquesData[niveauFilter][matiereFilter] &&
    documentsPedagogiquesData[niveauFilter][matiereFilter][uniteFilter]
      ? documentsPedagogiquesData[niveauFilter][matiereFilter][uniteFilter]
      : [];
  ...
  // Professors
  const uniqueProfs = uniqueSorted(DocumentsPedagogiques.map(c => c.professeur));
  ...
  const handleNiveauChange = (val) => {
    ...
    setMatiereFilter("");
    setUniteFilter("");
    setDocumentsPedagogiquesTitreFilter("");
  };
        ...
        <>
          ...
          <div className="filtersSection">
            ...
            >
              ...
              {[...new Set([
                ...DocumentsPedagogiques.map(c => c.niveau).filter(Boolean).map(s => s.trim()),
                ...Object.keys(documentsPedagogiquesData)
              ])].map((lvl, idx) => (
