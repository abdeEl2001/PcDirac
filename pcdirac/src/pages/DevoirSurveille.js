...
const DevoirSurveille = () => {
    const [DevoirSurveille, setDevoirSurveille] = useState([]); // generic name for courses/exercices
    ...
    const [loading, setLoading] = useState(true);
      ...
      // Apply user filters
      const displayedItems = DevoirSurveille.filter(item => {
        return (
